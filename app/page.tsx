				...
				<div className="px-lg max-w-container-max mx-auto relative z-10 flex flex-col items-center">
					...
					<div className="flex flex-col sm:flex-row items-center gap-md opacity-0 animate-fade-in-up delay-200">
						<div className="relative w-full sm:w-auto">
							...
							<Link
								href="/browse"
								className="relative bg-primary cursor-pointer text-on-primary font-body-md text-body-md px-6 py-3 rounded-lg hover:bg-primary-container hover:scale-105 transition-all duration-300 shadow-sm w-full sm:w-auto flex items-center justify-center gap-2 hover:shadow-[0_0_20px_rgba(192,193,255,0.6)] group"
							>
								Explore Components
								<ArrowRight
									size={18}
